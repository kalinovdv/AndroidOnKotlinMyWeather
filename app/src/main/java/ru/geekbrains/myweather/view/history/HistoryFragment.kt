...
import ru.geekbrains.myweather.databinding.FragmentHistoryBinding
    ...
    private fun renderData(appState: AppState) {
        when(appState) {
            ...
            is AppState.Error -> {
                binding.historyFragmentRecyclerview.visibility = View.VISIBLE
                binding.includedLoadingLayout.loadingLayout.visibility = View.GONE
                binding.historyFragmentRecyclerview.showSnackBar(getString(R.string.error), getString(R.string.reload),  {viewModel.getAllHistory()})
            }
        }
    }
